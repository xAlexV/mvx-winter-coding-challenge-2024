...
WASM_PATH = "./arena-sc/output/arena-sc.wasm"
ABI_PATH = "./arena-sc/output/arena-sc.abi.json"
...
SC_ADDRESS = "erd1qqqqqqqqqqqqqpgqca83c29quyvafu0ezy84flqzs2ypydqqq7vqvlzv4z"  # Arena sc
